...
#CLIENT_SECRETS_FILE variable specifies the name of a file that contains
...
#Thiss method calls the API's youtube.subscriptions.insert method to add a
...
def subscriptions_list_my_subscriptions(youtube, **kwargs):
    kwargs = remove_empty_kwargs(**kwargs)

subscriptions_list_my_subscriptions(youtube,
